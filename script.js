...
// Verifica se o navegador suporta a Media Query 'prefers-color-scheme'
if (window.matchMedia && window.matchMedia('(prefers-color-scheme: dark)').matches) {
  // Se estiver no modo escuro, força o estilo claro
  document.documentElement.setAttribute('data-theme', 'light');
}

function countDown() {
  const diasCasamento = new Date('22 Juny 2024 16:00:00');
